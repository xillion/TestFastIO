...
OBJECTS += ./FastIO/FastIO.o
OBJECTS += ./MbedJSONValue/MbedJSONValue.o
OBJECTS += ./TARGET_COFFEEBOX/PeripheralPins.o
OBJECTS += ./TARGET_COFFEEBOX/system_clock.o
OBJECTS += ./main.o
...
OBJECTS += ./mbed-os/targets/TARGET_STM/TARGET_STM32L4/TARGET_STM32L476xG/device/TOOLCHAIN_GCC_ARM/startup_stm32l476xx.o
...
INCLUDE_PATHS += -I../.
INCLUDE_PATHS += -I.././FastIO
INCLUDE_PATHS += -I.././FastIO/Devices
INCLUDE_PATHS += -I.././MbedJSONValue
INCLUDE_PATHS += -I.././TARGET_COFFEEBOX
...
INCLUDE_PATHS += -I.././mbed-os/targets/TARGET_STM/TARGET_STM32L4/TARGET_STM32L476xG/device
...
INCLUDE_PATHS += -I..//home/embedder/Projects/MBED/sources/TestFastIO/mbed-os

LIBRARY_PATHS :=
LIBRARIES :=
LINKER_SCRIPT ?= .././mbed-os/targets/TARGET_STM/TARGET_STM32L4/TARGET_STM32L476xG/device/TOOLCHAIN_GCC_ARM/STM32L476XX.ld
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1566611634.3136098
CXX_FLAGS += -DDEVICE_INTERRUPTIN=1
CXX_FLAGS += -DTARGET_COFFEEBOX
CXX_FLAGS += -DTARGET_NAME=COFFEEBOX
...
ASM_FLAGS += -I..
ASM_FLAGS += -I../FastIO
ASM_FLAGS += -I../FastIO/Devices
ASM_FLAGS += -I../MbedJSONValue
ASM_FLAGS += -I../TARGET_COFFEEBOX
ASM_FLAGS += -I../mbed-os
...
ASM_FLAGS += -I../mbed-os/targets/TARGET_STM/TARGET_STM32L4/TARGET_STM32L476xG/device
...
ASM_FLAGS += -I/home/embedder/Projects/MBED/sources/TestFastIO/mbed-os
ASM_FLAGS += -include
